...
public interface ITransactionService
{
    ...
    Task<ResultDTO<List<TransactionDTO>?>> GetTransactions(string userId, int limit, int offset, OrderByType orderBy, CategoryType? categoryType = null, List<string>? categoriesId = null);
